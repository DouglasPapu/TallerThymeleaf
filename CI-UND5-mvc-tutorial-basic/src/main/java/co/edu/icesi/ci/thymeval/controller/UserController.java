...
public class UserController {
	...
	public String saveUser(@Validated(Validation1.class) User user, BindingResult bindingResult,
	...
	public String saveUser2(@Validated(Validation2.class) User user, BindingResult bindingResult,
			@RequestParam(value = "action", required = true) String action, Model model) {
	...
	public String updateUser(@PathVariable("id") long id,
			@RequestParam(value = "action", required = true) String action, @Validated(Validation3.class) User user,
